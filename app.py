...
if st.session_state["step"]==1:
    ...
    if prods.empty:
        ...
        if "product_sel" not in st.session_state or st.session_state.get("product_sel") not in display:
            st.session_state["product_sel"]=display[0]
        sel = st.radio("Ürün", options=display, index=display.index(st.session_state["product_sel"]), key="product_sel")
        ...
        st.session_state["product_sel"]=sel
